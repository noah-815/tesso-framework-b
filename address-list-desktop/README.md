...
세로는 목록 영역 600px + 상하 영역의 자연 높이(802px)이고, **상한 85vh**
(`0.85 × 뷰포트 높이`) 입니다. 상한에 걸리면 다이얼로그가 줄고 목록이 스크롤됩니다.
...
|---|---|---|---|
| dialog · 560 + mid | 560 × 765 (85vh) | 560 × 765 (85vh) | 560 × 802 |
| dialog · 560 + px | 560 × 765 (85vh) | 560 × 765 (85vh) | 560 × 802 |
| dialog · vw + mid | 224 × 765 (85vh) | 420 × 765 (85vh) | 560 × 802 |
